...
func _ready() -> void:
	...
	shopOption1.mouse_entered.connect(_on_mouse_entered.bind(shopOption1))
	shopOption1.mouse_exited.connect(_on_mouse_exited.bind(shopOption1))
	shopOption1.pressed.connect(_on_buyIngredient.bind("air's brevity"))
	
	shopOption2.mouse_entered.connect(_on_mouse_entered.bind(shopOption2))
	shopOption2.mouse_exited.connect(_on_mouse_exited.bind(shopOption2))
	shopOption2.pressed.connect(_on_buyIngredient.bind("desert calm"))
	
	
	shopOption3.mouse_entered.connect(_on_mouse_entered.bind(shopOption3))
	shopOption3.mouse_exited.connect(_on_mouse_exited.bind(shopOption3))
	shopOption3.pressed.connect(_on_buyIngredient.bind("dried ocean"))
	
	
	shopOption4.mouse_entered.connect(_on_mouse_entered.bind(shopOption4))
	shopOption4.mouse_exited.connect(_on_mouse_exited.bind(shopOption4))
	shopOption4.pressed.connect(_on_buyIngredient.bind("ear of the sea"))
	
	
	shopOption5.mouse_entered.connect(_on_mouse_entered.bind(shopOption5))
	shopOption5.mouse_exited.connect(_on_mouse_exited.bind(shopOption5))
	shopOption5.pressed.connect(_on_buyIngredient.bind("gaia's teeth"))
	
	
	shopOption6.mouse_entered.connect(_on_mouse_entered.bind(shopOption6))
	shopOption6.mouse_exited.connect(_on_mouse_exited.bind(shopOption6))
	shopOption6.pressed.connect(_on_buyIngredient.bind("dragon's egg"))
	
	
	shopOption7.mouse_entered.connect(_on_mouse_entered.bind(shopOption7))
	shopOption7.mouse_exited.connect(_on_mouse_exited.bind(shopOption7))
	shopOption7.pressed.connect(_on_buyIngredient.bind("spring crystal"))
	
	
	shopOption8.mouse_entered.connect(_on_mouse_entered.bind(shopOption8))
	shopOption8.mouse_exited.connect(_on_mouse_exited.bind(shopOption8))
	shopOption8.pressed.connect(_on_buyIngredient.bind("string of lovers"))
	
	
	shopOption9.mouse_entered.connect(_on_mouse_entered.bind(shopOption9))
	shopOption9.mouse_exited.connect(_on_mouse_exited.bind(shopOption9))
	shopOption9.pressed.connect(_on_buyIngredient.bind("venus's eyelashes"))
	
	
	shopOption10.mouse_entered.connect(_on_mouse_entered.bind(shopOption10))
	shopOption10.mouse_exited.connect(_on_mouse_exited.bind(shopOption10))
	shopOption10.pressed.connect(_on_buyIngredient.bind("winter crystal"))
	
	
	shopOption11.mouse_entered.connect(_on_mouse_entered.bind(shopOption11))
	shopOption11.mouse_exited.connect(_on_mouse_exited.bind(shopOption11))
	shopOption11.pressed.connect(_on_buyIngredient.bind("psychic stone"))
	
	
	shopOption12.mouse_entered.connect(_on_mouse_entered.bind(shopOption12))
	shopOption12.mouse_exited.connect(_on_mouse_exited.bind(shopOption12))
	shopOption12.pressed.connect(_on_buyIngredient.bind("shattered sky"))
	
	
	shopOption13.mouse_entered.connect(_on_mouse_entered.bind(shopOption13))
	shopOption13.mouse_exited.connect(_on_mouse_exited.bind(shopOption13))
	...
	shopOption15.mouse_exited.connect(_on_mouse_exited.bind(shopOption15))
	shopOption15.pressed.connect(_on_buyIngredient.bind("a thorny heart"))
	
	shopOption16.mouse_entered.connect(_on_mouse_entered.bind(shopOption16))
...
func _on_mouse_entered(button: Variant):
	button.material.set_shader_parameter("outline_thickness", 5.0)


func _on_mouse_exited(button: Variant):
