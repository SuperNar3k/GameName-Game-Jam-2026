...
func Populate():
	...
	createIngredient("tears of trees", "string of pearls", 0, "res://assets/ingredients/tears of tree.PNG", 1, true)
	createIngredient("tears of trees powder", "crushed string of pearls", 0, "res://assets/ingredients/tears of tree powder.PNG", 1, false)
